...
- Spring backend의 report 도메인이 Gemini API로 완료 Todo와 집중 기록 기반 KPT 회고 레포트를 생성합니다 (v1.11.0~). 회고·레포트는 마크다운으로 렌더링됩니다.

### 5) PWA 설치와 오프라인 대응

- 모바일·데스크탑에 앱으로 설치할 수 있으며, 서비스워커 캐싱으로 재방문 로딩을 개선합니다.
