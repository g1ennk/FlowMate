...
또한 사용자는 작업 후 일일, 주간, 월간, 연간 회고를 통해 피드백 스스로 하여 생산성 개선을 돕는다.
...
- **일일/주간/월간/연간 회고**로 집중 패턴을 돌아보고 회고할 수 있다.
...
8. 이후 사용자는 일일/주간/월간/연간 회고를 통해 어떤 작업들을 했는지, 얼마나 집중했는지를 확인한다.
...
- `/review`에서 **일일/주간/월간/연간 회고** 확인
- 회고 페이지는 통계 요약 + 흐름 차트 + 회고 입력을 포함
- MVP에선 일일/주간/월간/연간을 지원
